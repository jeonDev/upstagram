...
CREATE TABLE `DM_CHAT_ROOM_USER` (
	`DM_ROOM_USER_NO`	BIGINT	NOT NULL	auto_increment primary key COMMENT '채팅방사용자번호',
	`DM_CHAT_ROOM_NO`	BIGINT	NOT NULL	COMMENT '채팅방 번호',
	`ID`	VARCHAR(30)	NOT NULL	COMMENT '아이디',
	`REG_DTTM`	DATETIME	NULL	COMMENT '등록일자',
	`LAST_DTTM`	DATETIME	NULL	COMMENT '수정일자'
...
CREATE TABLE `LOGIN_HISTORY` (
    `HISTORY_NO` BIGINT NOT NULL    auto_increment primary key COMMENT '기록번호',
	`ID`	VARCHAR(30)	NOT NULL	COMMENT '아이디',
...
CREATE TABLE `MEMBER_INFO` (
	...
	`LAST_DTTM` DATETIME null COMMENT '수정시간',
	`PROFILE_IMAGE` VARCHAR(100) NULL COMMENT '프로필사진'
);
...
DROP TABLE IF EXISTS `FEED_KEEP`;

CREATE TABLE `FEED_KEEP` (
	`FEED_KEEP_NO`	BIGINT	NOT NULL	auto_increment COMMENT '피드보관번호',
	`FEED_NO`	BIGINT	NOT NULL	COMMENT '피드 번호',
	`ID`	VARCHAR(30)	NOT NULL	COMMENT '아이디',
	`REG_DTTM`	DATETIME	NULL	COMMENT '등록일자',
	`LAST_DTTM`	DATETIME	NULL	COMMENT '수정일자',
	PRIMARY KEY (FEED_KEEP_NO, FEED_NO, ID)
);
...
DROP TABLE IF EXISTS `FEED_HASHTAG`;

CREATE TABLE `FEED_HASHTAG` (
	`HASHTAG_NO`	BIGINT	NOT NULL	auto_increment primary key COMMENT '해시태그 번호',
	`FEED_NO`	BIGINT	NOT NULL	COMMENT '피드 번호',
	`HASHTAG`	VARCHAR(20)	NULL	COMMENT '해시태그',
	`REG_DTTM`	DATETIME	NULL	COMMENT '등록일자',
	`REG_ID`	VARCHAR(20)	NULL	COMMENT '등록자',
	`LAST_DTTM`	DATETIME	NULL	COMMENT '수정일자',
	`LAST_ID`	VARCHAR(20)	NULL	COMMENT '수정자'
...
ALTER TABLE `DM_CHAT` ADD CONSTRAINT `FK_DM_CHAT_ROOM_TO_DM_CHAT_1` FOREIGN KEY (
	`DM_CHAT_ROOM_NO`
)
REFERENCES `DM_CHAT_ROOM` (
	`DM_CHAT_ROOM_NO`
);

ALTER TABLE `DM_CHAT_ROOM_USER` ADD CONSTRAINT `FK_DM_CHAT_ROOM_TO_DM_CHAT_ROOM_USER_1` FOREIGN KEY (
	`DM_CHAT_ROOM_NO`
)
REFERENCES `DM_CHAT_ROOM` (
	`DM_CHAT_ROOM_NO`
...
ALTER TABLE `DM_CHAT_ROOM_USER` ADD CONSTRAINT `FK_MEMBER_INFO_TO_DM_CHAT_ROOM_USER_1` FOREIGN KEY (
	`ID`
)
...
ALTER TABLE `FEED_HASHTAG` ADD CONSTRAINT `PK_FEED_HASHTAG` PRIMARY KEY (
	`HASHTAG_NO`
);

ALTER TABLE `FEED_HASHTAG` ADD CONSTRAINT `FK_FEED_TO_FEED_HASHTAG_1` FOREIGN KEY (
	`FEED_NO`
)
REFERENCES `FEED` (
	`FEED_NO`
...
ALTER TABLE `FEED_KEEP` ADD CONSTRAINT `FK_FEED_TO_FEED_KEEP_1` FOREIGN KEY (
	`FEED_NO`
)
REFERENCES `FEED` (
	`FEED_NO`
...
ALTER TABLE `FEED_KEEP` ADD CONSTRAINT `FK_MEMBER_INFO_TO_FEED_KEEP_1` FOREIGN KEY (
	`ID`
)
REFERENCES `MEMBER_INFO` (
	`ID`
